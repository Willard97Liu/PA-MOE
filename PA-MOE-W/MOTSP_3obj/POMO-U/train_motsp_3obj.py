...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': '/data/s3056713/WE/WE-CA_MOE/MOTSP_3obj/POMO-U/result/20250415_205051_train__tsp_mix',  # directory path of pre-trained model and log files saved.
        'epoch': 192,  # epoch version of pre-trained model to laod.
    }
}
