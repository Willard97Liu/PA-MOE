...
tester_params = {
    ...
    'model_load': {
        ...
        'info': "MOTSP100 Author's code (Retrain WS)",
        'epoch': 200,
    },
    # 'test_episodes': 1,
    # 'test_batch_size': 1,
...
def main(n_sols = 101):
    ...
    test_path = f"./data/kro/kro{env_params['problem_size']}.pt"
    ...
    plt.legend()
    print(f"Saving Pareto plot to: {tester.result_folder}/{pareto_fig}")
