...
class CVRPModel(nn.Module):
    ...
    def pre_forward(self, reset_state, pref):
        ...
        self.encoded_nodes, moe_loss, embedded_pref = self.encoder(depot_xy, node_xy_demand, pref)
    ...
    def forward(self, state):
        ...
        if state.selected_count == 0:  # First Move, depot
            ...
            probs, moe_loss = self.decoder(encoded_last_node, state.load, self.embedded_pref, ninf_mask=state.ninf_mask)
...
class CVRP_Encoder(nn.Module):
    ...
    def forward(self, depot_xy, node_xy_demand, pref):
        ...
        moe_loss = 0 
        embedded_node, loss_data = self.embedding_node(node_xy_demand, embedded_pref)
...
class CVRP_Decoder(nn.Module):
    ...
    def forward(self, encoded_last_node, load, mid_embd_pref, ninf_mask):
