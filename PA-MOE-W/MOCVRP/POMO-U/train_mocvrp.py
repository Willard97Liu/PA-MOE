...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': '/data/s3056713/WE/WE-CA_MOE/MOCVRP/POMO-U/result/20250415_205244_train_cvrp_mix',  # directory path of pre-trained model and log files saved.
        'epoch': 164,  # epoch version of pre-trained model to laod.
    }
}
