...
from models.MOKPModel import KPModel as Model
...
class TSPTrainer:
    ...
    def _train_one_batch(self, batch_size):
        ...
        # else:
        #     size = torch.randint(50, 201, (1,)).item()
        size = torch.randint(50, 201, (1,)).item()
        ...
        while not done:
            ...
            action_w_finisehd[state.finished] = self.env.problem_size  # this is dummy item with 0 size 0 value
