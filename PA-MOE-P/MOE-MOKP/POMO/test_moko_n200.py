...
tester_params = {
    ...
    'model_load': {
        'path': './result/saved_kp200_model',  # directory path of pre-trained model and log files saved.
...
def main(n_sols = 101):
    ...
    loaded_problem = load_dataset('/data/liuw2/test_data/mokp/mokp%d_test_seed1234.pkl'%(problem_size))
