...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': '/data/liuw2/MOE/MOE-BIMOCVRP/POMO/result/20250402_230226_train_cvrp_n100',  # directory path of pre-trained model and log files saved.
        'epoch': 185,  # epoch version of pre-trained model to laod.
    }
}
