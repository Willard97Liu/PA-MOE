...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': '/data/liuw2/MOE_CNH/CNH-TRITSP/TRI-MOTSP/POMO/result/20250303_104521_train__tsp_n20',  # directory path of pre-trained model and log files saved.
        'epoch': 25,  # epoch version of pre-trained model to laod.
    }
}
