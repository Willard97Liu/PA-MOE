...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': '/data/liuw2/MOE_CNH/CNH-CVRP_decoder_MOE/MOCVRP/POMO/result/20250310_105129_train_cvrp_n20',  # directory path of pre-trained model and log files saved.
        'epoch': 115,  # epoch version of pre-trained model to laod.
    }
}
